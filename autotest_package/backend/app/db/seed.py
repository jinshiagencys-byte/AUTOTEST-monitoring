...
_SETTING_SEED_ROWS = [
    ...
    (20, "LLM-setting: ANALYSIS-MODEL-GEMINI",       "Analysis Model",                 "",        "Text",      "",                                                "gemini-3.1-flash-lite",        "gemini-3.1-flash-lite"),
    (21, "LLM-setting: SELENIUM-MODEL-GEMINI",       "Selenium Model",                 "",        "Text",      "",                                                "gemini-3.1-flash-lite",        "gemini-3.1-flash-lite"),
    (22, "LLM-setting: RESULT-ANALYSIS-MODEL-GEMINI","Result Analysis Model",          "",        "Text",      "",                                                "gemini-3.1-flash-lite",        "gemini-3.1-flash-lite"),
